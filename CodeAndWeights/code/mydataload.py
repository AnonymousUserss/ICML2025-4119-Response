    ...
    def __init__(self, args, split='train', seed=0):
        ...
        if split in ['train']:
            ...
            if args.dataset == 'InsectWingbeat':
                Xtr, ytr, meta =load_classification(name='InsectWingbeat', split='train',extract_path='../timedata/dataset/')
            else:
            ...
            if args.dataset == 'InsectWingbeat':
                Xte, yte, meta =load_classification(name='InsectWingbeat', split='test',extract_path='../timedata/dataset/')
            else:
